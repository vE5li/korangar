...
fn main() {
    ...
    let mut client_map_handler = create_handler!(ServerType::Map, Direction::Incoming, [
        ...
        SpriteChangePacket_4,
        InventoyStartPacket,
        RegularItemListPacket_20180912,
        EquippableItemListPacket_20200916,
        InventoryEndPacket,
        EquippableSwitchItemListPacket,
        MapTypePacket,
        UpdateSkillTreePacket,
        UpdateHotkeysPacket_20190522,
        InitialStatsPacket,
        ...
        DisplaySkillEffectNoDamagePacket_20130731,
        DisplayPlayerHealEffect,
        StatusChangePacket_20120618,
        DamagePacket,
        DamagePacket_20131223,
        ...
        StateChangePacket,
        QuestEffectPacket,
        ItemPickupPacket_20200916,
        RemoveItemFromInventoryPacket,
        ServerTickPacket,
        RequestPlayerDetailsSuccessPacket_20150225,
        RequestEntityDetailsSuccessPacket,
        UpdateMonsterHealthPointsPacket,
        RequestPlayerAttackFailedPacket,
        NpcDialogPacket,
        RequestEquipItemStatusPacket_20121205,
        RequestUnequipItemStatusPacket_20130000,
        Packet8302,
        Packet0b18,
        ...
        NotifySkillUnitPacket_20130731,
    ...
    let mut server_map_handler = create_handler!(ServerType::Map, Direction::Outgoing, [
        ...
        RequestEquipItemPacket_20120925,
        RequestUnequipItemPacket,
        UseSkillAtIdPacket,
        UseSkillOnGroundPacket_20180207,
        StartUseSkillPacket,
        EndUseSkillPacket,
        AddFriendPacket,
        RemoveFriendPacket,
