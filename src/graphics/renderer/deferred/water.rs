mod vertex_shader {
    vulkano_shaders::shader! {
        ty: "vertex",
        path: "shaders/water_vertex_shader.glsl"
    }
}
...
mod fragment_shader {
    vulkano_shaders::shader! {
        ty: "fragment",
        path: "shaders/water_fragment_shader.glsl"
    }
}
...
impl WaterRenderer {
    ...
    pub fn update(&mut self, delta_time: f32) {
        self.wave_offset += delta_time;
    }

    pub fn render(&self, camera: &dyn Camera, builder: &mut CommandBuilder, vertex_buffer: WaterVertexBuffer) {
