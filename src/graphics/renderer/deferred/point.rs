...
impl PointLightRenderer {
    ...
    pub fn render(&self, render_target: &mut <DeferredRenderer as Renderer>::Target, camera: &dyn Camera, vertex_buffer: ScreenVertexBuffer, position: Vector3<f32>, color: Color, range: f32) {
