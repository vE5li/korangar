...
pub(crate) use copy::SelectorCopyDispatcher;
...
impl ComputePassContext<{ BindGroupCount::Two }> for SelectorComputePassContext {
    ...
    fn create_pass<'encoder>(
        ...
        pass.set_bind_group(1, &global_context.picker_bind_group, &[]);
    ...
    fn bind_group_layout(device: &Device) -> [&'static BindGroupLayout; 2] {
        [
            ...
            GlobalContext::picker_bind_group_layout(device),
        ]
    }
}
