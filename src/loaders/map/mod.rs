...
impl MapLoader {
    fn load(
        ...
        let offset = Vector3::new(
            gat_data.map_width as f32 * MAP_OFFSET,
            0.0,
            gat_data.map_height as f32 * MAP_OFFSET,
        );
        map_data.resources.objects.iter_mut().for_each(|object| object.offset(offset));
        map_data
            .resources
            .objects
            .iter_mut()
        ...
        let map = Arc::new(Map::new(
            ...
            map_data.resources.light_source,
            map_data.resources.sound_source,
            map_data.resources.effect_source,
...
fn parse_ground_data(ground_file: String, game_file_loader: &mut GameFileLoader) -> Result<GroundData, String> {
...
fn parse_gat_data(gat_file: String, game_file_loader: &mut GameFileLoader) -> Result<GatData, String> {
