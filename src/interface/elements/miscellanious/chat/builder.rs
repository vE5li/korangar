...
impl<FONT> ChatBuilder<Unset, FONT> {
    pub fn with_messages(self, messages: Remote<Vec<ChatMessage>>) -> ChatBuilder<Remote<Vec<ChatMessage>>, FONT> {
...
impl ChatBuilder<Remote<Vec<ChatMessage>>, Rc<RefCell<FontLoader>>> {
