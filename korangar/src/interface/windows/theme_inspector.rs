                                    ...
                                    children: (
                                        button! {
                                            ...
                                            event: move |state: &Context<ClientState>, queue: &mut EventQueue<ClientState>| {
                                                queue.queue(InputEvent::ReloadInterfaceTheme {
                                                    theme_type: InterfaceThemeType::Menu,
                                                    name: state.get(&self.window_state_path.menu_theme_name()).clone(),
                                                });
                                            },
                                        },
                                        button! {
                                            text: "Save",
                                            event: move |state: &Context<ClientState>, queue: &mut EventQueue<ClientState>| {
                                                queue.queue(InputEvent::SaveInterfaceTheme {
                                                    theme_type: InterfaceThemeType::Menu,
                                                    name: state.get(&self.window_state_path.menu_theme_name()).clone(),
                                                });
                                            },
                                ...
                                split! {
                                    ...
                                    children: (
                                        button! {
                                            ...
                                            event: move |state: &Context<ClientState>, queue: &mut EventQueue<ClientState>| {
                                                queue.queue(InputEvent::ReloadInterfaceTheme {
                                                    theme_type: InterfaceThemeType::InGame,
                                                    name: state.get(&self.window_state_path.in_game_theme_name()).clone(),
                                                });
                                            },
                                        },
                                        button! {
                                ...
                                split! {
                                    ...
                                    children: (
                                        button! {
                                            text: "Load",
                                            event: move |state: &Context<ClientState>, queue: &mut EventQueue<ClientState>| {
                                                queue.queue(InputEvent::ReloadWorldTheme {
                                                    name: state.get(&self.window_state_path.world_theme_name()).clone(),
                                                });
                                            },
                                        },
                                        button! {
                                            text: "Save",
                                            event: move |state: &Context<ClientState>, queue: &mut EventQueue<ClientState>| {
                                                queue.queue(InputEvent::SaveWorldTheme {
                                                    name: state.get(&self.window_state_path.world_theme_name()).clone(),
                                                });
                                            },
                                        },
