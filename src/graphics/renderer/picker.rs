mod vertex_shader {
    vulkano_shaders::shader! {
        ty: "vertex",
        path: "shaders/picker_vertex_shader.glsl"
    }
}
...
mod fragment_shader {
    vulkano_shaders::shader! {
        ty: "fragment",
        path: "shaders/picker_fragment_shader.glsl"
    }
}
...
impl PickerRenderer {
    ...
    pub fn render(&self, camera: &dyn Camera, builder: &mut CommandBuilder, vertex_buffer: TileVertexBuffer) {
