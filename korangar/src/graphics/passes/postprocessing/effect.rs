...
impl Drawer<{ BindGroupCount::One }, { ColorAttachmentCount::One }, { DepthAttachmentCount::None }> for PostProcessingEffectDrawer {
    ...
    fn new(
        ...
        let shader_module = if capabilities.supports_bindless() == BindlessSupport::Full {
        ...
        let bind_group_layout = if capabilities.supports_bindless() == BindlessSupport::Full {
        ...
        let bind_group = if capabilities.supports_bindless() == BindlessSupport::Full {
        ...
        let bind_group_layouts: &[&BindGroupLayout] = if capabilities.supports_bindless() == BindlessSupport::Full {
        ...
        Self {
            bindless_support: capabilities.supports_bindless() == BindlessSupport::Full,
