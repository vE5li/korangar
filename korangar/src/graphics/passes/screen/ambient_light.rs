...
use crate::graphics::{Capabilities, GlobalContext, LIGHT_ATTACHMENT_BLEND};

const SHADER: ShaderModuleDescriptor = include_wgsl!("shader/ambient_light.wgsl");
const DRAWER_NAME: &str = "screen ambient light";

pub(crate) struct ScreenAmbientLightDrawer {
    pipeline: RenderPipeline,
}

impl Drawer<{ BindGroupCount::Two }, { ColorAttachmentCount::One }, { DepthAttachmentCount::None }> for ScreenAmbientLightDrawer {
