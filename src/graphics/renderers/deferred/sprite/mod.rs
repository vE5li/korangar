...
impl SpriteRenderer {
    ...
    fn build(&self, render_target: &mut <DeferredRenderer as Renderer>::Target, texture: Texture, screen_position: Vector2<f32>, screen_size: Vector2<f32>, texture_position: Vector2<f32>, texture_size: Vector2<f32>, color: Color, smooth: bool) {
    ...
    pub fn render_indexed(&self, render_target: &mut <DeferredRenderer as Renderer>::Target, texture: Texture, window_size: Vector2<usize>, screen_position: Vector2<f32>, screen_size: Vector2<f32>, color: Color, column_count: usize, cell_index: usize, smooth: bool) {
        ...
        self.build(render_target, texture, screen_position, screen_size, Vector2::new(offset_x, offset_y), Vector2::new(unit, unit), color, smooth);
    }
