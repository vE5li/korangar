...
pub struct Localization {
    ...
    party_window_title: String,
    party_create_text_box_message: String,
    party_invite_text_box_message: String,
    party_leave_button_text: String,
    party_expel_button_text: String,
