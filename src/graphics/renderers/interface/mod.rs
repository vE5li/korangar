...
impl InterfaceRenderer { 
    ...
    pub fn create_render_target(&self) -> <Self as Renderer>::Target {
        ...
        <Self as Renderer>::Target::new(self.device.clone(), self.queue.clone(), self.render_pass.clone(), self.dimensions, SampleCount::Sample4, image_usage, vulkano::format::ClearValue::Float([0.0, 0.0, 0.0, 0.0]))
    }
