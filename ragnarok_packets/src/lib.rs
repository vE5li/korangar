...
pub trait Packet: std::fmt::Debug + Clone {
    ...
    //     &self,
    // ) -> Box<dyn korangar_interface::element::PrototypeElement<App> + Send>;
}
...
bitflags::bitflags! {
    #[derive(Debug, Clone)]
    #[cfg_attr(feature = "interface", derive(rust_state::RustState, korangar_interface::element::PrototypeElement))]
