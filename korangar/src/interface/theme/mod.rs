...
//             hovered_background_color: Mutable::new(Color::rgb_u8(200, 70,
// 255)),             disabled_background_color:
// Mutable::new(Color::monochrome_u8(70)),             foreground_color:
// Mutable::new(Color::monochrome_u8(200)),
// hovered_foreground_color: Mutable::new(Color::rgb_u8(220, 170, 215)),
//             disabled_foreground_color:
// Mutable::new(Color::monochrome_u8(140)),             debug_foreground_color:
// Mutable::new(Color::rgb_u8(230, 140, 230)),             corner_radius:
// MutableRange::new(                 CornerRadius::uniform(26.0),
...
//             ),
//             icon_size: MutableRange::new(ScreenSize::uniform(16.0),
// ScreenSize::default(), ScreenSize::uniform(20.0)),
// icon_text_offset: MutableRange::new(                 ScreenPosition { left:
// 40.0, top: 4.0 },                 ScreenPosition::default(),
...
//                 ScreenPosition { left: 100.0, top: 20.0 },
//             ),
//             font_size: MutableRange::new(FontSize::new(14.0),
// FontSize::new(6.0), FontSize::new(30.0)),             height_bound:
// dimension_bound!(26),         }
//     }
// }
//
...
//             hovered_background_color: Mutable::new(Color::rgb_u8(140, 120,
// 140)),             disabled_background_color:
// Mutable::new(Color::monochrome_u8(70)),             foreground_color:
// Mutable::new(Color::monochrome_u8(200)),
// hovered_foreground_color: Mutable::new(Color::rgb_u8(220, 170, 215)),
//             disabled_foreground_color:
// Mutable::new(Color::monochrome_u8(140)),             debug_foreground_color:
// Mutable::new(Color::rgb_u8(230, 140, 230)),             corner_radius:
// MutableRange::new(CornerRadius::uniform(6.0), CornerRadius::default(),
// CornerRadius::uniform(30.0)),             icon_offset: MutableRange::new(
//                 ScreenPosition { left: 7.0, top: 2.5 },
//                 ScreenPosition::default(),
//                 ScreenPosition::uniform(20.0),
//             ),
//             icon_size: MutableRange::new(ScreenSize::uniform(10.0),
// ScreenSize::default(), ScreenSize::uniform(20.0)),
// icon_text_offset: MutableRange::new(                 ScreenPosition { left:
// 20.0, top: 1.0 },                 ScreenPosition::default(),
//                 ScreenPosition { left: 100.0, top: 20.0 },
//             ),
//             text_offset: MutableRange::new(
...
// }
//
// impl korangar_interface::theme::ButtonTheme<InterfaceSettings> for
// ButtonTheme {     fn background_color(&self) -> Color {
...
//             title_background_color: Mutable::new(Color::rgba_u8(70, 60, 70,
// 0)),             foreground_color: Mutable::new(Color::rgb_u8(150, 70, 255)),
...
//             title_corner_radius:
// MutableRange::new(CornerRadius::uniform(6.0), CornerRadius::default(),
// CornerRadius::uniform(30.0)),             border_size:
// MutableRange::new(ScreenSize::uniform(30.0), ScreenSize::default(),
// ScreenSize::uniform(30.0)),             text_offset: MutableRange::new(
//                 ScreenPosition { left: 5.0, top: -1.0 },
//                 ScreenPosition::default(),
...
//             ),
//             font_size: MutableRange::new(FontSize::new(20.0),
// FontSize::new(6.0), FontSize::new(30.0)),             title_height:
// dimension_bound!(30),             anchor_color:
// Mutable::new(Color::rgba_u8(60, 60, 150, 255)),
...
//             corner_radius: MutableRange::new(CornerRadius::uniform(4.0),
// CornerRadius::default(), CornerRadius::uniform(30.0)),
// title_corner_radius: MutableRange::new(CornerRadius::uniform(6.0),
// CornerRadius::default(), CornerRadius::uniform(30.0)),
// border_size: MutableRange::new(                 ScreenSize { width: 12.0,
// height: 6.0 },                 ScreenSize::default(),
...
//             font_size: MutableRange::new(FontSize::new(14.0),
// FontSize::new(6.0), FontSize::new(30.0)),             title_height:
// dimension_bound!(12),             anchor_color:
// Mutable::new(Color::rgba_u8(150, 100, 100, 255)),
// closest_anchor_color: Mutable::new(Color::rgba_u8(255, 180, 0, 255)),
//         }
//     }
// }
//
// impl korangar_interface::theme::WindowTheme<InterfaceSettings> for
// WindowTheme {     fn background_color(&self) -> Color {
//         self.background_color.get()
//     }
//
...
//             hovered_foreground_color: Mutable::new(Color::rgb_u8(190, 145,
// 185)),             corner_radius:
// MutableRange::new(CornerRadius::uniform(6.0), CornerRadius::default(),
// CornerRadius::uniform(30.0)),             border_size:
// MutableRange::new(ScreenSize::uniform(5.0), ScreenSize::default(),
// ScreenSize::uniform(20.0)),             element_offset: MutableRange::new(
...
//             ),
//             icon_size: MutableRange::new(ScreenSize::uniform(6.0),
// ScreenSize::default(), ScreenSize::uniform(20.0)),             text_offset:
// MutableRange::new(                 ScreenPosition { left: 14.0, top: 1.5 },
//                 ScreenPosition::default(),
//                 ScreenPosition { left: 50.0, top: 20.0 },
//             ),
//             gaps: MutableRange::new(ScreenSize::uniform(6.0),
// ScreenSize::default(), ScreenSize::uniform(20.0)),             font_size:
// MutableRange::new(FontSize::new(14.0), FontSize::new(6.0),
// FontSize::new(30.0)),         }
//     }
// }
//
...
// }
//
// impl korangar_interface::theme::ExpandableTheme<InterfaceSettings> for
// ExpandableTheme {     fn background_color(&self) -> Color {
//         self.background_color.get()
//     }
//
...
//             corner_radius: MutableRange::new(CornerRadius::uniform(6.0),
// CornerRadius::default(), CornerRadius::uniform(30.0)),
// text_offset: MutableRange::new(                 ScreenPosition { left: 5.0,
// top: 0.0 },                 ScreenPosition::uniform(-10.0),
//                 ScreenPosition::uniform(20.0),
//             ),
//             font_size: MutableRange::new(FontSize::new(14.0),
// FontSize::new(6.0), FontSize::new(30.0)),             size_bound:
// size_bound!(120 > 50% < 300, 0),         }
//     }
// }
//
...
//             hovered_background_color: Mutable::new(Color::rgb_u8(130, 100,
// 120)),             foreground_color: Mutable::new(Color::rgb_u8(220, 220,
// 220)),             corner_radius:
// MutableRange::new(CornerRadius::uniform(6.0), CornerRadius::default(),
// CornerRadius::uniform(30.0)),             text_offset: MutableRange::new(
...
//             hovered_background_color: Mutable::new(Color::rgb_u8(200, 140,
// 100)),             foreground_color: Mutable::new(Color::rgb_u8(220, 220,
// 220)),             corner_radius: MutableRange::new(
...
// 100)),             foreground_color: Mutable::new(Color::rgb_u8(220, 220,
// 220)),             corner_radius:
// MutableRange::new(CornerRadius::uniform(1.0), CornerRadius::default(),
// CornerRadius::uniform(30.0)),             text_offset: MutableRange::new(
//                 ScreenPosition { left: 9.0, top: 0.0 },
//                 ScreenPosition::uniform(-10.0),
//                 ScreenPosition::uniform(20.0),
//             ),
//             font_size: MutableRange::new(FontSize::new(12.0),
// FontSize::new(6.0), FontSize::new(30.0)),             size_bound:
// size_bound!(25, 12),         }
//     }
// }
//
// impl korangar_interface::theme::CloseButtonTheme<InterfaceSettings> for
// CloseButtonTheme {     fn background_color(&self) -> Color {
//         self.background_color.get()
//     }
//
//     fn hovered_background_color(&self) -> Color {
...
// }
//
// impl korangar_interface::theme::SliderTheme<InterfaceSettings> for
// SliderTheme {     fn background_color(&self) -> Color {
//         self.background_color.get()
//     }
//
...
//             hovered_background_color: Mutable::new(Color::rgb_u8(70, 60,
// 80)),             focused_background_color:
// Mutable::new(Color::monochrome_u8(100)),             text_color:
// Mutable::new(Color::monochrome_u8(200)),             ghost_text_color:
// Mutable::new(Color::monochrome_u8(100)),             focused_text_color:
// Mutable::new(Color::monochrome_u8(200)),             corner_radius:
// MutableRange::new(                 CornerRadius::uniform(26.0),
//                 CornerRadius::default(),
//                 CornerRadius::uniform(30.0),
//             ),
//             font_size: MutableRange::new(FontSize::new(15.0),
// FontSize::new(6.0), FontSize::new(50.0)),             text_offset:
// MutableRange::new(                 ScreenPosition { left: 15.0, top: 6.0 },
//                 ScreenPosition::default(),
...
// Mutable::new(Color::monochrome_u8(200)),             corner_radius:
// MutableRange::new(CornerRadius::uniform(6.0), CornerRadius::default(),
// CornerRadius::uniform(30.0)),             font_size:
// MutableRange::new(FontSize::new(14.0), FontSize::new(6.0),
// FontSize::new(50.0)),             text_offset: MutableRange::new(
...
//             font_size: MutableRange::new(FontSize::new(14.0),
// FontSize::new(6.0), FontSize::new(50.0)),             broadcast_color:
// Mutable::new(Color::rgb_u8(210, 210, 210)),             server_color:
// Mutable::new(Color::rgb_u8(255, 255, 210)),             error_color:
// Mutable::new(Color::rgb_u8(255, 150, 150)),             information_color:
// Mutable::new(Color::rgb_u8(200, 255, 200)),         }
//     }
// }
//
...
//             corner_radius: MutableRange::new(CornerRadius::uniform(2.0),
// CornerRadius::default(), CornerRadius::uniform(30.0)),
// line_color: Mutable::new(Color::rgb_u8(80, 90, 80)),             line_width:
// MutableRange::new(2.0, 0.5, 4.0),             bar_height:
// MutableRange::new(15.0, 5.0, 30.0),             bar_gap:
// MutableRange::new(ScreenSize { width: 1.0, height: 5.0 },
// ScreenSize::default(), ScreenSize {                 width: 10.0,
//                 height: 20.0,
//             }),
//             bar_corner_radius: MutableRange::new(CornerRadius::default(),
// CornerRadius::default(), CornerRadius::uniform(15.0)),
// bar_text_color: Mutable::new(Color::monochrome_u8(0)),
// bar_text_size: MutableRange::new(14.0, 6.0, 50.0),
// bar_text_offset: MutableRange::new(                 ScreenPosition { left:
// 7.0, top: 0.0 },                 ScreenPosition { left: 0.0, top: -10.0 },
...
// }
//
// impl korangar_interface::theme::ProfilerTheme<InterfaceSettings> for
// ProfilerTheme {     fn background_color(&self) -> Color {
//         self.background_color.get()
//     }
//
//     fn corner_radius(&self) -> CornerRadius {
...
//
// impl Themes {
//     pub fn new(menu: InterfaceTheme, main: InterfaceTheme, game: GameTheme)
// -> Self {         Self {
//             #[cfg(feature = "debug")]
...
//             #[cfg(feature = "debug")]
//             print_debug!("failed to load theme from file {}",
// theme_file.magenta());
//
...
//
//         std::fs::read_to_string(theme_file).ok().and_then(|data|
...
//
//         let data = ron::ser::to_string_pretty(self,
// PrettyConfig::new()).unwrap();         std::fs::write(theme_file,
