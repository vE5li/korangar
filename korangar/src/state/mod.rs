...
impl ClientState {
    pub fn new(
        ...
        time_phase!("load themes", {
            let menu_theme = InterfaceTheme::load(&interface_settings.menu_theme, InterfaceTheme::default_menu);
            let in_game_theme = InterfaceTheme::load(&interface_settings.in_game_theme, InterfaceTheme::default_playing);
