...
use korangar_interface::element::{Element, ElementRenderer, ElementState};
    ...
    fn render_measurement(
        ...
        if alpha > VISIBILITY_THRESHHOLD {
            ...
            let screen_clip = ScreenClip {
                left: renderer.clip.left + x_position,
                top: renderer.clip.top + y_position,
                right: renderer.clip.left + x_position + x_size,
                bottom: renderer.clip.top + y_position + y_size,
            };
            ...
            korangar_interface::application::RenderLayer::render_text(
                renderer.renderer,
                &text,
                text_position,
                screen_clip,
