...
impl Timer {
    ...
    pub fn new_dynamic(name: String) -> Self {
        ...
        Self { start_time, completed, name }
    }
    ...
    pub fn stop(mut self) {
        ...
        if stack_size() > 0 && get_message_count() == 0 {
            ...
            decrement_stack();
            print_debug!("{}{}{} {} {}completed{} ({}{}ms{})", YELLOW, self.name, NONE, ARROW, GREEN, NONE, CYAN, self.start_time.elapsed().unwrap().as_millis(), NONE);
        }
    ...
    fn drop(&mut self) {
        ...
        if !self.completed {
            ...
            if stack_size() > 0 && get_message_count() == 0 {
                ...
                decrement_stack();
                print_debug!("{}{}{} {} {}failed{} ({}{}ms{})", YELLOW, self.name, NONE, ARROW, RED, NONE, CYAN, self.start_time.elapsed().unwrap().as_millis(), NONE);
            }
