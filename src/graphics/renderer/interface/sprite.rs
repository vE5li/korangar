...
impl SpriteRenderer {
    ...
    pub fn render(&self, builder: &mut CommandBuilder, window_size: Vector2<usize>, texture: Texture, screen_position: Vector2<f32>, screen_size: Vector2<f32>, clip_size: Vector2<f32>, color: Color, smooth: bool) {
        ...
        self.build(builder, texture, screen_position, screen_size, clip_size, Vector2::new(0.0, 0.0), Vector2::new(1.0, 1.0), color, smooth);
    }

    pub fn render_indexed(&self, builder: &mut CommandBuilder, window_size: Vector2<usize>, texture: Texture, screen_position: Vector2<f32>, screen_size: Vector2<f32>, clip_size: Vector2<f32>, color: Color, column_count: usize, cell_index: usize, smooth: bool) {
        ...
        self.build(builder, texture, screen_position, screen_size, clip_size, Vector2::new(offset_x, offset_y), Vector2::new(unit, unit), color, smooth);
    }
}
