{
  ...
  outputs = {
    ...
    flake-utils.lib.eachDefaultSystem (system: let
      ...
      run-smoke-test = pkgs.writeShellScriptBin "run-smoke-test" ''
    ...
    in {
      ...
      devShells.default = pkgs.mkShell {
        ...
        buildInputs = with pkgs;
          [libpcap nasm nixpkgs-fmt openssl shaderc shader-slang vulkan-headers vulkan-loader run-smoke-test]
