mod vertex_shader {
    vulkano_shaders::shader! {
        ty: "vertex",
        path: "shaders/entity_picker_vertex_shader.glsl"
    }
}
...
mod fragment_shader {
    vulkano_shaders::shader! {
        ty: "fragment",
        path: "shaders/entity_picker_fragment_shader.glsl"
    }
}
...
impl EntityRenderer {
    ...
    pub fn render(&self, render_target: &mut <PickerRenderer as Renderer>::Target, camera: &dyn Camera, texture: Texture, position: Vector3<f32>, origin: Vector3<f32>, size: Vector2<f32>, cell_count: Vector2<usize>, cell_position: Vector2<usize>)
    {
